SELECT [2010 Engagement Data].[Date Engaged], Count([2010 Engagement Data].[Engagement ID]) AS ["Number of Engagements"], Avg([2010 Engagement Data].[Rings Cost]) AS ["Average Cost of Rings"]
